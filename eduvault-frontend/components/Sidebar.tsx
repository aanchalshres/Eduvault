...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside className={`fixed lg:static top-0 left-0 h-full w-[280px] bg-[#09090B]/95 backdrop-blur-xl text-white p-6 flex flex-col border-r border-white/10 transition-all duration-500 shadow-2xl z-[50] ${
        isSidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
      }`}>
        <div className="flex items-center justify-between mb-12">
          <Link href="/" className="flex items-center gap-3 px-2 no-underline group">
